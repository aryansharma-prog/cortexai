...
export default function MessageBubble({
  ...
  // ==================== USER MESSAGE: ALIGNED TO RIGHT (LIKE CHATGPT) ====================
  if (isUser) {
    return (
      <div className="flex justify-end w-full my-2 sm:my-3">
        <div className="max-w-[88%] sm:max-w-[78%] md:max-w-[70%] rounded-2xl rounded-tr-xs bg-stone-100/90 border border-stone-200/90 text-slate-900 px-4 py-3 shadow-2xs space-y-1 transition-all">
          <div className="flex items-center justify-between gap-3 pb-1 border-b border-stone-200/50">
            <div className="flex items-center gap-1.5">
              <div className="w-5 h-5 rounded-full bg-orange-100 border border-orange-200 flex items-center justify-center text-[10px] font-bold text-orange-600">
                U
              </div>
            ...
            <button
              ...
              className="text-[10px] font-mono text-slate-400 hover:text-orange-600 flex items-center gap-1 border-none bg-transparent cursor-pointer"
              title="Copy prompt"
            >
              {copiedMessage ? <Check size={11} className="text-emerald-600" /> : <Copy size={11} />}
              <span>{copiedMessage ? "Copied" : "Copy"}</span>
            </button>
          </div>
          <p className="text-xs sm:text-[13.5px] text-slate-800 leading-relaxed font-normal whitespace-pre-wrap break-words pt-0.5">
            {content}
          </p>
        </div>
      </div>
  ...
  // ==================== ASSISTANT / SYSTEM MESSAGE: ALIGNED TO LEFT (LIKE CHATGPT) ====================
  return (
    <div className="flex justify-start w-full my-3 sm:my-4" onClick={handleBubbleClick}>
      <div className="w-full max-w-4xl space-y-2.5">
        ...
        <div className="flex items-center justify-between px-1">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-semibold text-slate-900 tracking-tight font-sans">
        ...
        <div className="rounded-2xl rounded-tl-xs bg-white border border-stone-200/90 shadow-sm p-4 sm:p-5 space-y-4">
